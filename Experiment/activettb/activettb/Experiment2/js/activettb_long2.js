...
//////////////////////////////////////////////////////////////////////////
var all=features(); 
alien1[0]=all[0]; // is the comparison Alien on the right: random from above
alien2[0]=all[1];
alien3[0]=all[2];  
...
var prob=Math.exp(p)/(1+Math.exp(p)); // prob of y=c1
...
if (document.getElementById('gender2').checked) {var  gender = 2}
 ...
 var money =Math.round(((totalscore/10) - 50)/100);
 var presentmoney='This equals a total bonus of $'+money+'.';
